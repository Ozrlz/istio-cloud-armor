...
# Create nginx.ozrlz.com cert and key
openssl req -out nginx.ozrlz.com.csr -newkey rsa:2048 -nodes -keyout nginx.ozrlz.com.key \
-subj "/CN=nginx.ozrlz.com/O=Flask organization"
openssl x509 -req -days 365 -CA ozrlz.com.crt -CAkey ozrlz.com.key \
-set_serial 0 -in nginx.ozrlz.com.csr -out nginx.ozrlz.com.crt